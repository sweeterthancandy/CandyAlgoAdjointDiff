...
auto __KoBarrierCallOption(const double x, const double K, const double tau, const double r, const double sigma, const double B)
{
    ...
    auto __call_result_13056212 = __FactorPlus(__symbol_1, __symbol_2, __symbol_3, __symbol_13);
    const double __symbol_14 = __call_result_13056212[0];
    const double d_12890124___symbol_1 = __call_result_13056212[1];
    const double d_12890124___symbol_2 = __call_result_13056212[2];
    const double d_12890124___symbol_3 = __call_result_13056212[3];
    const double d_12890124___symbol_13 = __call_result_13056212[4];
    const double __symbol_15 = std::erfc(-(__symbol_14) / std::sqrt(2)) / 2;
    const double __symbol_6 = __symbol_5 / __symbol_4;
    auto __call_result_13057532 = __FactorMinus(__symbol_1, __symbol_2, __symbol_3, __symbol_6);
    const double __symbol_7 = __call_result_13057532[0];
    const double d_12892884___symbol_1 = __call_result_13057532[1];
    const double d_12892884___symbol_2 = __call_result_13057532[2];
    const double d_12892884___symbol_3 = __call_result_13057532[3];
    const double d_12892884___symbol_6 = __call_result_13057532[4];
    ...
    const double __adj11 = __symbol_5;
    const double __adj49 = -__adj11;
    const double __adj32 = __symbol_4;
    const double __adj33 = std::pow(__adj32, 2.000000);
    const double __adj50 = __adj49 / __adj33;
    const double __adj47 = d_12892884___symbol_6;
    const double __adj40 = __symbol_7;
    const double __adj41 = std::pow(__adj40, 2.000000);
    const double __adj42 = 0.500000 * __adj41;
    const double __adj43 = -__adj42;
    const double __adj44 = std::exp(__adj43);
    const double __adj45 = __adj44 / 2.506628;
    const double __adj15 = __symbol_24;
    const double __adj39 = -1.000000 * __adj15;
    const double __adj46 = __adj45 * __adj39;
    const double __adj48 = __adj47 * __adj46;
    const double __adj51 = __adj50 * __adj48;
    const double __adj34 = __symbol_11;
    const double __adj35 = -__adj34;
    const double __adj36 = __adj35 / __adj33;
    const double __adj28 = __symbol_12;
    const double __adj29 = std::pow(__adj11, __adj28);
    const double __adj27 = std::log(__adj11);
    const double __adj30 = __adj29 * __adj27;
    const double __adj25 = d_12890124___symbol_13;
    const double __adj17 = __symbol_14;
    const double __adj18 = std::pow(__adj17, 2.000000);
    const double __adj20 = 0.500000 * __adj18;
    const double __adj21 = -__adj20;
    const double __adj22 = std::exp(__adj21);
    const double __adj23 = __adj22 / 2.506628;
    const double __adj24 = __adj23 * __adj15;
    const double __adj26 = __adj25 * __adj24;
    const double __adj31 = __adj30 * __adj26;
    const double __adj37 = __adj36 * __adj31;
    const double __adj52 = __adj51 + __adj37;
    const double __adj12 = std::pow(__adj11, 2.000000);
    const double __adj13 = __adj11 / __adj12;
    const double __adj4 = __symbol_21;
    const double __adj5 = __symbol_20;
    const double __adj7 = std::pow(__adj4, __adj5);
    const double __adj6 = __adj5 / __adj4;
    const double __adj8 = __adj7 * __adj6;
    const double __adj2 = __symbol_23;
    const double __adj1 = __symbol_16;
    const double __adj3 = __adj2 * __adj1;
    const double __adj9 = __adj8 * __adj3;
    const double __adj14 = __adj13 * __adj9;
    const double result_d_x = __adj52 + __adj14;
    const double __adj55 = __symbol_9;
    const double __adj56 = std::pow(__adj55, 2.000000);
    const double __adj58 = -2.000000 / __adj56;
    const double __adj53 = __adj32 / __adj33;
    const double __adj54 = __adj53 * __adj31;
    const double result_d_K = __adj58 * __adj54;
    const double __adj61 = d_12892884___symbol_3;
    const double __adj62 = __adj61 * __adj46;
    const double __adj59 = d_12890124___symbol_3;
    const double __adj60 = __adj59 * __adj24;
    const double result_d_tau = __adj62 + __adj60;
    const double __adj73 = d_12892884___symbol_2;
    const double __adj74 = __adj73 * __adj46;
    const double __adj71 = d_12890124___symbol_2;
    const double __adj72 = __adj71 * __adj24;
    const double __adj75 = __adj74 + __adj72;
    const double __adj66 = __symbol_17;
    const double __adj67 = std::pow(__adj66, 2.000000);
    const double __adj68 = __adj66 / __adj67;
    const double __adj63 = std::log(__adj4);
    const double __adj64 = __adj7 * __adj63;
    const double __adj65 = __adj64 * __adj3;
    const double __adj69 = __adj68 * __adj65;
    const double __adj70 = -2.000000 * __adj69;
    const double result_d_r = __adj75 + __adj70;
    const double __adj85 = d_12892884___symbol_1;
    const double __adj86 = __adj85 * __adj46;
    const double __adj83 = d_12890124___symbol_1;
    const double __adj84 = __adj83 * __adj24;
    const double __adj87 = __adj86 + __adj84;
    const double __adj80 = __symbol_1;
    const double __adj81 = 2.000000 * __adj80;
    const double __adj76 = __symbol_19;
    const double __adj77 = -__adj76;
    const double __adj78 = __adj77 / __adj67;
    const double __adj79 = __adj78 * __adj65;
    const double __adj82 = __adj81 * __adj79;
    const double result_d_sigma = __adj87 + __adj82;
    const double __adj99 = __adj53 * __adj48;
    const double __adj96 = __adj28 / __adj11;
    const double __adj97 = __adj29 * __adj96;
    const double __adj98 = __adj97 * __adj26;
    const double __adj100 = __adj99 + __adj98;
    const double __adj93 = -__adj32;
    const double __adj94 = __adj93 / __adj12;
    const double __adj95 = __adj94 * __adj9;
    const double __adj101 = __adj100 + __adj95;
    const double __adj91 = -1.000000;
    const double __adj88 = __symbol_22;
    const double __adj89 = __adj88 * __adj1;
    const double __adj92 = __adj91 * __adj89;
    const double result_d_B = __adj101 + __adj92;
