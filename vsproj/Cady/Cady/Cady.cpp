...
double BlackScholesCallOptionTestBareMetal(double t, double T, double r, double S, double K, double vol, double* d_t = nullptr, double* d_T = nullptr, double* d_r = nullptr, double* d_S = nullptr, double* d_K = nullptr, double* d_vol = nullptr)
{
    ...
    // Matrix function F_5 => __statement_0
    //     __symbol_32 => 1.000000
    ...
    // Matrix function F_10 => __statement_1
    ...
    //     __statement_1 => ((__symbol_8)/(std::pow(__symbol_8, 2.000000)))
    //     __symbol_8 => (((-(__statement_1)))/(std::pow(__symbol_8, 2.000000)))
    ...
    //     __statement_0 => __symbol_29
    //     __symbol_29 => __statement_0

    double const __symbol_34 = ((__statement_0) * (__symbol_29));

    // Matrix function F_33 => __statement_8
    //     __symbol_34 => 1.000000
    ...
    double const __symbol_54 = ((__statement_1) / (__symbol_8));
    ...
    double const __symbol_58 = ((__symbol_16) / (__statement_2));

    double const __symbol_42 = ((0.500000) * (__statement_2));

    double const __symbol_61 = ((__statement_3)+(__symbol_7));

    double const __symbol_64 = ((__statement_4)-(__statement_2));

    double const __symbol_100 = std::pow(__statement_5, 2.000000);
    ...
    double const __symbol_98 = ((-1.000000) * (__statement_0));
    ...
    double const __symbol_91 = std::pow(__statement_4, 2.000000);
    ...
    double const __symbol_88 = ((__statement_1) * (__statement_0));
    ...
    double const __symbol_107 = std::pow(__statement_2, 2.000000);
    ...
    double const __symbol_72 = std::erfc(-(__statement_4) / std::sqrt(2)) / 2;

    double const __symbol_116 = ((__statement_6) * (__statement_0));
    ...
    double const __symbol_108 = ((__statement_2) / (__symbol_107));
    ...
    double const __symbol_75 = ((__statement_1) * (__statement_6));

    double const __symbol_67 = std::erfc(-(__statement_5) / std::sqrt(2)) / 2;

    double const __symbol_70 = ((__symbol_8) * (__statement_7));
    ...
    double const __symbol_141 = ((__statement_7) * (__symbol_98));

    double const __symbol_138 = (-(__statement_1));
